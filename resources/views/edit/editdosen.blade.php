...
<nav class="navbar bg-body-tertiary" style="box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">
  <div class="container-fluid">
    <span class="navbar-brand mb-0 h1">Update Data Dosen</span>
  </div>
</nav>

<form action="/updatedosen/{{ $datadosen->id }}" method="post">
    {{ csrf_field() }}
    @method('PUT')
   ...
   <div class="form-group mb-3">
    ...
    <a href="/datadosen" class="btn btn-primary" role="button">Batal</a>
</form>
